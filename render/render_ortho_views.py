# -*- coding: utf-8 -*-
"""Renders four orthographic views (front, left, back, right) of a CAD mesh: the unmodified render.

Usage (headless):
    blender -b -P render_ortho_views.py -- --input model.stl --out output_dir --elev 20 --margin 1.30
Options: --input (.stl .obj .ply .glb .gltf .fbx), --out, --res (default 1024), --bg white|transparent
(default white), --elev in degrees (default 0), --margin (default 1.15; the study uses 1.30).
Output: front.png, left.png, back.png, right.png. Tested with Blender 3.6+ and 4.x.
"""
