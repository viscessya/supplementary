# -*- coding: utf-8 -*-
"""Clay render of a reconstructed mesh (.glb/.stl) in the same style as the dataset renders (matte gray
0.42, roughness 0.6, white world, the same three area lights, orthographic camera), from one or more
camera directions given as azimuth:elevation in degrees.

Usage (Blender or the bpy module):
    python render_pompa_clay.py -- --in mesh.glb --out-dir render/ --views 45:25 135:25 --res 1024 --samples 64
"""
